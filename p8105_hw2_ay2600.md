...
- In the `mci_baseline_full`, there are 483 observations and 6
  variables. This data provided information of participants in the
  study.

- During the cleaning process, `janitor::clean_names()` function was
  used to standardize the variable names. `mutate` function recode the
  ...
  variable is recoded to `Carrier` and `Non carrier` categories. The
